 ...
 *
 */
public class Format_time extends BasicFunction {

	public final static FunctionSignature signatures[] = {
		new FunctionSignature(
				new QName("format-time", XSLTModule.NAMESPACE_URI, XSLTModule.PREFIX),
	 ...
	 * @param context
	 */
	public Format_time(XQueryContext context, FunctionSignature signature) {
