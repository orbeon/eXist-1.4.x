 ...
 *
 */
public class PreserveSpace extends Declaration {

    private String elements = null;

    public PreserveSpace(XSLContext context) {
		super(context);
	}
    ...
    public void dump(ExpressionDumper dumper) {
        dumper.display("<xsl:preserve-space");
        if (elements != null) {
    ...
    public String toString() {
    	...
    	result.append("<xsl:preserve-space");
