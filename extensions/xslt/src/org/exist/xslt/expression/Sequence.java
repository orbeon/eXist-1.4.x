 ...
 *
 */
public class Sequence extends SimpleConstructor {
	
	private String select = null;

	public Sequence(XSLContext context) {
		super(context);
	}
	...
	public org.exist.xquery.value.Sequence eval(org.exist.xquery.value.Sequence contextSequence, Item contextItem) throws XPathException {
